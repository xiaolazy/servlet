...
public class RedisUtil {
    ...
    static {
        ...
        //redis未设置了密码：
        //redis的主机IP地址
        String redisHost = "123.57.189.47";
        //redis的端口号
        Integer redisPort = Integer.parseInt("6377");
        jedisPool = new JedisPool(config, redisHost, redisPort,8000,"lyy54321.");
    }
    ...
    /**
     * @description: 创建Stirngs对象实例
     * @parameter:
     * @author: lyy
     **/

    public static Strings getStrings(){
        return getInstance().STRINGS;
    }
    ...
    public class Lists {/**
     ...
     /*   public long linsert(String key, BinaryClient.LIST_POSITION where, String pivot, String value) {
         ...
         * @return 记录总数
         */
//        public long linsert(byte[] key, BinaryClient where, byte[] pivot, byte[] value) {
//            Jedis jedis = getJedis();
