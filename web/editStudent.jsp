  ...
  <form class="layui-form layui-form-pane" id="demo2" lay-filter="example">
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="name" lay-verify="title" value="${entity.name}" autocomplete="off" placeholder="请输入姓名" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="birthday" value="${entity.birthday}" id="date1" autocomplete="off" class="layui-input">
         </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">平均分</label>
      <div class="layui-input-block">
        <input type="text" name="avgscore"  value="${entity.avgscore}" lay-verify="number" autocomplete="off" placeholder="请输入平均分" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item layui-form-text">
      <label class="layui-form-label">备注</label>
      <div class="layui-input-block">
        <textarea placeholder="请输入备注" value="${entity.description}" class="layui-textarea" name="description"></textarea>
      </div>
    </div>
